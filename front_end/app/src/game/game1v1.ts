import { players, gameRunning, startGame, games } from './game';
import {
  winnerBoard,
  gamesboard,
  resetMatch,
...
import { player2Name, player1Name, reTournment } from './tournment';
...
export async function game1v1() {
  try {
    ...
    players.player1 = 0;
    players.player2 = 0;
    if (player2Name.innerText === '' || player2Name.innerText === null) getUserName(player2Name);
